          ...
          {isLoading || error ? (
            ...
            <>
              <div className={classes["details-row-item"]}>
                ...
                <div>
                  {stockPriceData && stockPriceData["Global Quote"]["02. open"]}
                </div>
              </div>
              <div className={classes["details-row-item"]}>
                ...
                <div>
                  {stockPriceData &&
                    stockPriceData["Global Quote"]["08. previous close"]}
                </div>
              </div>
              <div className={classes["details-row-item"]}>
                ...
                <div>
                  {stockPriceData &&
                    stockPriceData["Global Quote"]["06. volume"]}
                </div>
              </div>
              <div className={classes["details-row-item"]}>
          ...
          {isLoading || error ? (
            ...
            <>
              <div className={classes["details-row-item"]}>
                ...
                <div>
                  {stockPriceData && stockPriceData["Global Quote"]["03. high"]}
                </div>
              </div>
              <div className={classes["details-row-item"]}>
                <div className={classes["title"]}>Low</div>
                <div>
                  {stockPriceData && stockPriceData["Global Quote"]["04. low"]}
                </div>
              </div>
